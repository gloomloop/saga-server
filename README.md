...
Saga (Structured Adventure Game Agent) Engine Server is a text-based adventure game server written in Go and optimized for use with tool-calling LLM agents. It is part of the Saga Engine open core, along with the Saga Engine Agent (coming soon).
